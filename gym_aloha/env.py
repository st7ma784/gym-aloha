...
class AlohaEnv(gym.Env):
    ...
    def _make_env_task(self, task_name):
        ...
        if "transfer_cube" in task_name:
            ...
            xml_path=ASSETS_DIR/"bimanual_viperx_transfer_cube.xml"#, "bimanual_viperx_insertion.xml", "bimanual_viperx_end_effector_transfer_cube.xml","bimanual_viperx_end_effector_insertion.xml"])
            physics = mujoco.Physics.from_xml_path(str(xml_path))
